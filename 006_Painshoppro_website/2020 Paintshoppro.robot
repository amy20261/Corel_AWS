...
Check Link_Home Page_STG
    ...
    FOR    ${line}    IN    @{lines}
        ...
        run keyword if    '${var}[1]' in 'en;de;fr;it;nl;jp'    verify link on home page_2019    paintshop-pro/ultimate    paintshop-pro/standard    paintshop-pro/ultimate    photo-video-bundle
    END
...
Check Link_Special Offer Page_STG
    ...
    FOR    ${line}    IN    @{lines}
        ...
        run keyword if    '${var}[1]' in 'en;de;fr;it;nl;jp'    run keyword and continue on failure    verify link in special offer page_2019    paintshop-pro/ultimate    paintshop-pro/standard    paintshop-pro/ultimate    photo-video-bundle    photomirage
        close all browsers
    END
