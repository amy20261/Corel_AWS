...
Check Link_Home Page_STG
    ...
    FOR    ${line}    IN    @{lines}
        ...
        Run keyword if    '${var}[1]' in 'en;de;fr;jp'    verify link on home page_2019    painter    painter-essentials    particleshop    brushes
    END
...
Check Link_Special Offer Page_STG
    ...
    FOR    ${line}    IN    @{lines}
        ...
        Run keyword if    '${var}[1]' in 'en;de;fr;jp'    run keyword and continue on failure    verify link in special offer page_2019    painter    painter    particleshop    painter-essentials    brush
        close all browsers
    END
